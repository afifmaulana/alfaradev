            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 mb-2">
                    <div class="full">
                        ...
                        <div class="center text-center">
                            <h5>Kami akan memberikan pelayanan dengan ramah dan sabar kepada client kami, serta akan memberikan solusi2 yang terbaik dari masalah yang di hadapi. Dan kami pun akan cepat dan tanggap untuk melayani anda.</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 mb-2">
                    <div class="full">
                        ...
                        <div class="center text-center">
                            <h5>AlfaraDev sudah berpengalaman dalam pengembangan Aplikasi dan Website sejak 2019, maka tepat sekali jika anda memilih kami untuk berkerjasama. </h5>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 mb-2">
                    <div class="full">
                        ...
                        <div class="center text-center">
                            <h5>Kami akan memberikan service yang terbaik untuk para client kami, kualitas yang kami berikan juga pasti akan baik, tidak perlu di ragukan lagi.</h5>
                        </div>
                    </div>
                </div>
