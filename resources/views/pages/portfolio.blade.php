        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 text_align_center">
                    <div class="full">
                        <svg id="ab0c8d57-73b5-4efc-a896-a2305a232bd8" data-name="Layer 1"
                            xmlns="http://www.w3.org/2000/svg" width="290" height="220" viewBox="0 0 1027.4958 696.05876">
                            <circle cx="696.2479" cy="355.70168" r="76.7521" fill="#6385ff" opacity="0.4" />
                            ...
                            <path d="M684.38771,318.87255l57.86439-85.95062s-87.63109,30.59259-77.68591,85.95062Z"
                                transform="translate(-86.2521 -101.97062)" fill="#6385ff" />
                            ...
                            <circle cx="282" cy="63.90193" r="4" fill="#6385ff" />
                            <circle cx="293" cy="63.90193" r="4" fill="#6385ff" />
                            <circle cx="304" cy="63.90193" r="4" fill="#6385ff" />
                            <rect x="286" y="84.90193" width="18" height="10" fill="#6385ff" />
                            <rect x="286" y="163.90193" width="88" height="10" fill="#6385ff" />
                            ...
                            <rect x="410" y="611.90193" width="88" height="10" fill="#6385ff" />
                            ...
                            <rect x="312.5" y="271.90193" width="348" height="2" fill="#6385ff" opacity="0.3" />
                            <rect x="312" y="306.90193" width="74" height="66" fill="#6385ff" opacity="0.3" />
                            ...
                            <path
                                ...
                                transform="translate(-86.2521 -101.97062)" fill="#6385ff" />
                            <circle cx="489.20618" cy="333.79786" r="4.88134" fill="#6385ff" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-86.2521 -101.97062)" fill="#6385ff" />
                            <circle cx="629.20618" cy="333.79786" r="4.88134" fill="#6385ff" />
                            <path
                                ...
                                transform="translate(-86.2521 -101.97062)" fill="#6385ff" />
                            <rect x="286" y="498.90193" width="88" height="10" fill="#6385ff" />
                            ...
                            <circle cx="611.7521" cy="512.70168" r="31.2479" fill="#6385ff" opacity="0.4" />
                            <circle cx="553.92017" cy="527.62605" r="21.92017" fill="#6385ff" opacity="0.4" />
                            ...
                            <circle cx="917.2479" cy="468.70168" r="110.2479" fill="#6385ff" opacity="0.4" />
                            ...
                            <path
                                ...
                                transform="translate(-86.2521 -101.97062)" fill="#6385ff" />
                            <circle cx="338.23982" cy="301.05004" r="4.88134" fill="#6385ff" />
                            <path
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 white_fonts">
                    ...
                    <a href="https://wa.me/6285156805245?text=Halo,%20Saya%20tertarik%20dengan%20jasa%20Anda,%20boleh%20saya%20tanya-tanya%20dulu?"
                        class="hvr-radial-out button-theme">Hubungi Kami ></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section layout_padding light_bg">
        <div class="container">
            ...
            <ul class="nav nav-tabs center" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active text-color theme_bg" id="web-tab" data-toggle="tab" href="#web" role="tab"
                        aria-controls="web" aria-selected="false">Website</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-color theme_bg" id="apps-tab" data-toggle="tab" href="#apps" role="tab"
                        aria-controls="contact" aria-selected="false">Apps</a>
                </li>
            </ul>
                ...
                <div class="tab-pane fade show active" id="web" role="tabpanel" aria-labelledby="web-tab">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                            <div class="card shadow p-3 light_bg">
                                <div class="center">
                                    <a href="#" data-toggle="modal" data-target="#apotek"><img class="img-responsive"
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                            <div class="card shadow p-3 light_bg">
                                <div class="center">
                                    <a href="#" data-toggle="modal" data-target="#fruitman"><img class="img-responsive"
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                            <div class="card shadow p-3 light_bg">
                                <div class="center">
                                    <a href="#" data-toggle="modal" data-target="#sim"><img class="img-responsive"
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                            <div class="card shadow p-3 light_bg">
                                <div class="center">
                                    <a href="#" data-toggle="modal" data-target="#travelme"><img class="img-responsive"
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                            <div class="card shadow p-3 light_bg">
                                <div class="center">
                                    <a href="#" data-toggle="modal" data-target="#wartegku"><img class="img-responsive"
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                            <div class="card shadow p-3 light_bg">
                                <div class="center">
                                    <a href="#" data-toggle="modal" data-target="#enews"><img class="img-responsive"
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                            <div class="card shadow p-3 light_bg">
                                <div class="center">
                                    <a href="#" data-toggle="modal" data-target="#evoting"><img class="img-responsive"
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                            <div class="card shadow p-3 light_bg">
                                <div class="center">
                                    <a href="#" data-toggle="modal" data-target="#gmc"><img class="img-responsive"
                ...
                <div class="tab-pane fade" id="apps" role="tabpanel" aria-labelledby="apps-tab">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                            <div class="card shadow p-3 light_bg">
                                <div class="center">
                                    <a href="#" data-toggle="modal" data-target="#donor"><img class="img-responsive"
                                            src="{{ asset('assets/images/portfolio/android/donor.png') }}" alt="#"
                                            width="280" height="180" /></a>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                            <div class="card shadow p-3 light_bg">
                                <div class="center">
                                    <a href="#" data-toggle="modal" data-target="#travelmeapps"><img class="img-responsive"
                                            src="{{ asset('assets/images/portfolio/android/travelme.png') }}" alt="#"
                                            width="280" height="180" /></a>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                            <div class="card shadow p-3 light_bg">
                                <div class="center">
                                    <a href="#" data-toggle="modal" data-target="#meeting"><img class="img-responsive"
                                            src="{{ asset('assets/images/portfolio/android/meeting.png') }}" alt="#"
                                            width="280" height="180" /></a>
                                </div>
                                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                            <div class="card shadow p-3 light_bg">
                                <div class="center">
                                    <a href="#" data-toggle="modal" data-target="#enewsapps"><img class="img-responsive"
                                            src="{{ asset('assets/images/portfolio/android/enews.png') }}" alt="#"
                                            width="280" height="180" /></a>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                            <div class="card shadow p-3 light_bg">
                                <div class="center">
                                    <a href="#" data-toggle="modal" data-target="#fruitmanapps"><img class="img-responsive"
                                            src="{{ asset('assets/images/portfolio/android/fruitman.png') }}" alt="#"
                                            width="280" height="180" /></a>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                            <div class="card shadow p-3 light_bg">
                                <div class="center">
                                    <a href="#" data-toggle="modal" data-target="#wartegkuapps"><img class="img-responsive"
                                            src="{{ asset('assets/images/portfolio/android/wartegku.png') }}" alt="#"
                                            width="280" height="180" /></a>
                                </div>
                                <div class="card-body">
